...
public class GlobalVariableCollectorInterpreter implements
		IASTvisitor<Void, ILexicalEnvironment, EvaluationException> {

	protected Set<String> globals;
	
	public GlobalVariableCollectorInterpreter() {
		globals= new HashSet<>();		
	}
	...
	public GlobalVariableCollectorInterpreter visit(IASTprogram iast) 
	 ...
	 * Visiteur
	 * 
	 * L'argument 'data' du visiteur est l'environnement lexical du nœud,
	 * calculé au fur et à mesure par le visiteur.
	 * Toute variable absente de l'environement lexical est une globale.
	 * La valeur associée à une variable dans l'environnement est toujours
	 * nulll : on n'est interessé que par l'existence de la variable.
	 */
