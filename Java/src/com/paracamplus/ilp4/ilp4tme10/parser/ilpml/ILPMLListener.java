...
import antlr4.ILPMLgrammar4tme10Parser.DefinedContext;
...
public class ILPMLListener implements ILPMLgrammar4tme10Listener {
	...
	public void exitDefined(DefinedContext ctx) {
		ctx.node = factory.newDefined(factory.newVariable(ctx.var.getText()));		
	...
	public void exitExists(ExistsContext ctx) {
		ctx.node = factory.newExists(factory.newVariable(ctx.var.getText()));
