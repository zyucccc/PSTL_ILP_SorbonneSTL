...
/*tme 8*/
extern ILP_Object ILP_read_property(ILP_Object property, ILP_Object target);
extern ILP_Object ILP_write_property(ILP_Object property, ILP_Object target, ILP_Object value);
extern ILP_Object ILP_has_property(ILP_Object property, ILP_Object target);
